...
const Card: React.FC<CardProps> = ({ name, image, description, id }) => {
  ...
  return (
    <article onClick={handleCardClick} className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 max-w-sm mx-auto mt-8 shadow-lg bg-white">
